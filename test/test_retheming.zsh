...
test_merging() {
  ...
  assertGitPromptEquals '[00m([01;35mmaster[00m|[01;33mMERGE[00m|[31m✖1[00m)[00m'
}
...
test_merging_all_metrics() {
  ...
  assertGitPromptEquals '[00m([01;35mmaster[00m|L[00m|[01;33mMERGE[00m|↓2[00m↑1[00m[31m●3[00m[31m✖4[00m[34m✚5[00m[36m…6[00m[01;34m⚑7[00m)[00m'
}
...
test_rebasing() {
  ...
  assertGitPromptEquals '[00m([01;35m:abc1234[00m|[01;33mREBASE 3/10[00m|[01;32m✔[00m)[00m'
...
test_rebasing_all_metrics() {
  ...
  assertGitPromptEquals '[00m([01;35m:abc1234[00m|L[00m|[01;33mREBASE 2/7[00m|[31m●3[00m[31m✖4[00m[34m✚5[00m[36m…6[00m[01;34m⚑7[00m)[00m'
}

test_merging_all_metrics_show_upstream() {
  ZSH_GIT_PROMPT_SHOW_UPSTREAM=2
  ...
  assertGitPromptEquals '[00m([01;35mmaster[00m|[01;34morigin[00m[00m|[01;33mMERGE[00m|↓2[00m↑1[00m[31m●3[00m[31m✖4[00m[34m✚5[00m[36m…6[00m[01;34m⚑7[00m)[00m'
}
